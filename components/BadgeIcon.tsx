...
const BADGE_ICON_MAP: Record<string, { ios: string; android: string }> = {
  ...
  "Indigo Legend": { ios: "bolt.fill", android: "bolt" }, // lightning bolt icon
  ...
  "Indigo Vanguard": { ios: "figure.strengthtraining.traditional", android: "fitness-center" }, // strong arm/flexed bicep icon
